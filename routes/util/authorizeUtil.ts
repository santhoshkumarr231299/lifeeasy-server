...
const apiScreenCodes : any[] = [
  { [apiScreens.AllAuthenticated] : [ "/update-last-accessed", "/get-user-details", "/update-user-details", "/update-pass", "/payment/subscription", "/payment/subscription/success", "/activate-free-trial", "/menus", "/get-profile-image", "/profile-image-upload",
                                      "/get-themes", "/set-theme" ], prefix : "" },
